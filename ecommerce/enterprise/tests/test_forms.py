...
class EnterpriseOfferFormTests(EnterpriseServiceMockMixin, TestCase):
    ...
    def test_max_global_applications_clean(self):
        ...
        # create and  enterprise offer that can be used max 5 times and has already used 3 times
        ...
        # which is less than number of times this offer has already been used
